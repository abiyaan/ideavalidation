using IdeaValidation.backend.Configuration;
using IdeaValidation.backend.Data;
using IdeaValidation.backend.Models;
using IdeaValidation.backend.Services;
...
namespace IdeaValidation.backend
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<SmartSettings>(_configuration.GetSection("IdeaValidation"));
            ...
            //services.AddDbContextPool<Core.DataAccess.IdeaValidationContext>(options => options.UseSqlServer(ConfigurationExtensions.GetConnectionString(_configuration, "IdeaValidationContext")));
            services.AddDbContext<Core.DataAccess.IdeaValidationContext>(options => options.UseSqlServer(_configuration.GetConnectionString("IdeaValidationContext")));
